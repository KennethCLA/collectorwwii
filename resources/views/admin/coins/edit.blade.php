...
@section('admin-content')
        ...
        <form action="{{ route('admin.coins.update', $coin) }}" method="POST"
                ...
                <section class="rounded-xl border border-black/20 bg-black/10 p-6">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="date" name="date_of_issue" value="{{ old('date_of_issue', $coin->date_of_issue?->format('Y-m-d') ?? $coin->date_of_issue ?? '') }}"
