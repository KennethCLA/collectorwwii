        ...
        <div x-data="{ filtersOpen: false }" class="grid grid-cols-1 lg:grid-cols-[260px_minmax(0,1fr)] lg:gap-4 items-start">
            ...
            <div class="min-w-0 pr-4 pl-0">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-[240px_1fr] gap-4 items-center">
                        <div class="flex items-center justify-between">
                            <nav class="flex items-center pl-1 space-x-2 font-mono text-[11px] tracking-[0.15em] text-white/60 uppercase">
                                ...
                                <span class="text-khaki/70 font-mono text-[11px] tracking-[0.1em] uppercase">Newspapers</span>
                            </nav>
                ...
                <div class="bg-sage text-white rounded-md p-6">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('newspapers.index') }}" class="inline-block rounded-xl bg-black/30 hover:bg-black/40 ring-1 ring-khaki/30 px-4 py-2 font-stencil tracking-[0.15em] text-sm text-white uppercase transition">Clear filters</a>
                    </div>
                </div>
                @else
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 h-full">
                    ...
                    <a href="{{ route('newspapers.show', $newspaper) }}" target="_blank"
                        ...
                        <div class="mb-1 flex-grow h-auto">
                            <p class="font-mono text-[9px] tracking-widest text-white/30 text-right mb-1">#{{ str_pad($newspaper->id, 4, '0', STR_PAD_LEFT) }}</p>
                            <h3 class="text-lg font-bold text-center">{{ $newspaper->title }}</h3>
                            @if($newspaper->condition)
                            <p class="font-mono text-[9px] text-khaki/60 text-center mt-0.5 tracking-wider">{{ $newspaper->condition }}</p>
                            @endif
                        ...
                        <p class="text-sm text-center text-white/60 border-t border-white/15 py-1 h-20 flex flex-col justify-center">
                            ...
                            <span class="block text-xs text-white/60/90">{{ $newspaper->publication_date->format('d/m/Y') }}</span>
                            @endif
                        </p>
