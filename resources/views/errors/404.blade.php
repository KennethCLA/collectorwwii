...
<x-layout :mainClass="'w-full px-0 py-0'">
    <div class="flex min-h-[calc(100dvh-var(--header-h,0px))] items-center justify-center px-4">
        <div class="w-full max-w-lg rounded-2xl bg-sage border border-black/20 px-8 py-12 text-center shadow-lg noise-texture">
            ...
            <p class="font-stencil text-xs tracking-[0.4em] text-khaki/70 uppercase mb-2">Seite nicht gefunden</p>
            <p class="font-stencil text-7xl font-black text-white/15 tracking-widest">404</p>
            <h1 class="font-stencil mt-2 text-3xl font-black tracking-[0.2em] text-khaki uppercase">VERMISST</h1>
            <div class="mx-auto mt-4 h-px w-24 bg-khaki/30"></div>
            <p class="mt-4 text-sm text-white/60 tracking-wide">The page you are looking for has not been located.</p>
